...
import {PublicationId} from "../src/DataTypes.sol";

/// @title Example of an upgrade where the `whitelistCompetition` function no longer requires governance
/// and adds an `implementation` function to return the address of the implementation contract
contract LensCompetitionHubUpgradeTest is UUPSUpgradeable, Initializable {
